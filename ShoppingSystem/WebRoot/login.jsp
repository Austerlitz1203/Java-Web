                    ...
                    <div class="card-body bg-navbar2 pb-0" style="border: 1px solid black; border-top: none">
                        <form action="LoginServlet" method="post">
                            <div class="form-group">
                                ...
                                <label class=" m-0">Enter Validate Code : </label>
                                <div class="input-group">
                                    <input name="vcode"  type="text" class="bg-support my-input form-control" placeholder="Enter the Validate Code on the right" required/>
                                    <div class="input-group-append">
                                        <span class="input-group-text fa fa-eye " style="opacity:0"></span>
                                    </div>
