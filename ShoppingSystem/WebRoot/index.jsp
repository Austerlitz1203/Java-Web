                                    ...
                                    if(name==null || name.equals("all"))
                                        { 
                                          ...
                                          <div class="card hover" onclick="pd('<%= pro[i].getPid() %>','<%= request.getParameter("pno") %>','null')">
                                                  ...
                                                  <img class="p-1 card-img" src="./upload/<%= pro[i].getPpic() %>" style="max-height:160px; max-width:100%; width:auto;" alt="" />
                                                  </div>
                                          ...
                                          for(int i=start;i<(start+productLimit);i++)
                                            {
                                              ...
                                              <div class="card hover" onclick="pd('<%= sobj.getPid() %>','<%= request.getParameter("pno") %>','<%= name %>' )">
                                                  <div class="container text-center">
                                                    <img class="p-1 card-img" src="./upload/<%= sobj.getPpic() %>" style="max-height:160px; max-width:100%; width:auto;" alt="" />
                                                  </div>
